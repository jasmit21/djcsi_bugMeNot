...
import com.example.yourlinkapp.dialogfragments.RecoverPasswordDialogFragment;
...
public class LoginActivity extends AppCompatActivity implements OnPasswordResetListener {
	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		btnGoogleSignUp.setOnClickListener(new android.view.View.OnClickListener() {
			@Override
			public void onClick(android.view.View v) {
				signInWithGoogle();
			}
			...
			auth.signInWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
				...
				public void onComplete(@androidx.annotation.NonNull Task<AuthResult> task) {
					...
					if (task.isSuccessful()) {
						...
						String email = user.getEmail();
						uid = user.getUid();
						android.util.Log.i(TAG, "onComplete: user: " + user.toString());
						android.util.Log.i(TAG, "onComplete: email: " + email);
						android.util.Log.i(TAG, "onComplete: uid: " + uid);
	...
	private void checkMode(String email) {
		...
		query.addListenerForSingleValueEvent(new ValueEventListener() {
			...
			public void onCancelled(@androidx.annotation.NonNull DatabaseError databaseError) {
				android.util.Log.i(TAG, "onCancelled: canceled");
			}
		});
	}
