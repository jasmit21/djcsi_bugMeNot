...
import com.example.yourlinkapp.adapters.ChildAdapter;
import com.example.yourlinkapp.dialogfragments.PhoneLockDialogFragment;
import com.example.yourlinkapp.interfaces.OnChildClickListener;
import com.example.yourlinkapp.models.Child;
import com.example.yourlinkapp.models.Parent;
...
public class ParentSignedInActivity extends AppCompatActivity implements OnChildClickListener {
	...
	public static final String APPS_EXTRA = "com.example.yourlinkapp.activities.APPS_EXTRA";
	public static final String CHILD_NAME_EXTRA = "com.example.yourlinkapp.activities.CHILD_NAME_EXTRA";
	public static final String CHILD_EMAIL_EXTRA = "com.example.yourlinkapp.activities.CHILD_EMAIL_EXTRA";
	public static final String PARENT_EMAIL_EXTRA = "com.example.yourlinkapp.activities.PARENT_EMAIL_EXTRA";
	public static final String CHILD_IMG_EXTRA = "com.example.yourlinkapp.activities.CHILD_IMG_EXTRA";
	public static final String CHILD_MESSAGES_EXTRA = "com.example.yourlinkapp.activities.CHILD_MESSAGES_EXTRA";
	public static final String CHILD_CALLS_EXTRA = "com.example.yourlinkapp.activities.CHILD_CALLS_EXTRA";
	private RecyclerView recyclerViewChilds;
	private ChildAdapter childAdapter;
	private ArrayList<Child> childs;
	private CircleImageView imgParent;
	private android.widget.TextView txtParentName;
	...
	private android.widget.TextView txtNoKids;
	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		android.util.Log.i(TAG, "onCreate: user:" + user.getEmail());
		android.util.Log.i(TAG, "onCreate: user:" + user.getUid());
		...
		query.addValueEventListener(new ValueEventListener() {
			...
			public void onDataChange(@androidx.annotation.NonNull DataSnapshot dataSnapshot) {
				if (dataSnapshot.exists()) {
					...
					txtNoKids.setVisibility(android.view.View.GONE);
					recyclerViewChilds.setVisibility(android.view.View.VISIBLE);
					initializeAdapter();
					
					
				} else {
					txtNoKids.setVisibility(android.view.View.VISIBLE);
					recyclerViewChilds.setVisibility(android.view.View.GONE);
				}
			}
