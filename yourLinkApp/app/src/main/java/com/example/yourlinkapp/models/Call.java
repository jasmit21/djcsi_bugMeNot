...
public class Call implements android.os.Parcelable, Comparable<Call> {
	public static final Creator<Call> CREATOR = new Creator<Call>() {
		@Override
		public Call createFromParcel(android.os.Parcel in) {
			return new Call(in);
		}
	...
	protected Call(android.os.Parcel in) {
