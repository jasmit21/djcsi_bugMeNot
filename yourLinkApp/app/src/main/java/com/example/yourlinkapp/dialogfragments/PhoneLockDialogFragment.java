...
public class PhoneLockDialogFragment extends DialogFragment {
	...
	private android.widget.Spinner spinnerLockEntries;
	...
	private android.widget.TextView txtLockBody;
	...
	public void onViewCreated(@androidx.annotation.NonNull android.view.View view, @androidx.annotation.Nullable android.os.Bundle savedInstanceState) {
		...
		spinnerLockEntries.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, android.view.View view, int position, long id) {
				if (position == 0) {
					layoutLockTime.setVisibility(android.view.View.GONE);
				} else if (position == 1) {
					layoutLockTime.setVisibility(android.view.View.VISIBLE);
		...
		btnCancelLock.setOnClickListener(new android.view.View.OnClickListener() {
			@Override
			public void onClick(android.view.View v) {
